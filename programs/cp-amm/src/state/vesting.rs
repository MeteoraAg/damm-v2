...
use crate::{safe_math::SafeMath, state::InnerVesting};
...
impl Vesting {
    pub fn from_inner_vesting(position: Pubkey, inner_vesting: &InnerVesting) -> Vesting {
        Vesting {
            position,
            cliff_point: inner_vesting.cliff_point,
            period_frequency: inner_vesting.period_frequency,
            cliff_unlock_liquidity: inner_vesting.cliff_unlock_liquidity,
            liquidity_per_period: inner_vesting.liquidity_per_period,
            total_released_liquidity: inner_vesting.total_released_liquidity,
            number_of_period: inner_vesting.number_of_period,
            padding: [0u8; 14],
            padding2: [0u128; 4],
        }
    }
