...
pub mod ix_create_whitelist_protocol_fee_receiver;
pub use ix_create_whitelist_protocol_fee_receiver::*;
pub mod ix_close_whitelist_protocol_fee_receiver;
pub use ix_close_whitelist_protocol_fee_receiver::*;
pub mod ix_approve_whitelist_protocol_fee_receiver;
pub use ix_approve_whitelist_protocol_fee_receiver::*;
