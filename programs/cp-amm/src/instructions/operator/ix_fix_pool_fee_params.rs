...
pub fn handle_fix_pool_fee_params(
    ...
    // we dont need to check max fee numerator because the fee is static
    let fee_numerator_0 = base_fee_handler_0.get_min_fee_numerator()?;
    ...
    let fee_numerator_1 = base_fee_handler_1.get_min_fee_numerator()?;
