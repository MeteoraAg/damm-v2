...
pub fn process_swap_partial_fill_in<'a, 'b, 'info>(
    ...
    let swap_result =
        pool.get_swap_partial_fill_in_result(amount_in, fee_mode, trade_direction, current_point)?;
    ...
    let swap_event_v2 = EvtSwap2 {
        ...
        params: SwapParameters2 {
            amount_0: amount_in,
            amount_1: minimum_amount_out,
            swap_mode: SwapMode::PartialFillIn.into(),
        },
        swap_result,
