...
proptest! {
    ...
    fn test_reserve_wont_lost_when_swap_from_a_to_b(
        ...
        if amount_in <= max_amount_in {
            ...
            .get_swap_result_exact_in(amount_in, false, trade_direction, 0)
            .unwrap();
            ...
            .get_swap_result_exact_in(swap_result_0.output_amount, false, TradeDirection::BtoA, 0)
            .unwrap();
    ...
    fn test_reserve_wont_lost_when_swap_from_b_to_a(
        ...
        if amount_in <= max_amount_in {
            ...
            let swap_result_1 = pool
            .get_swap_result_exact_in(swap_result_0.output_amount, false, TradeDirection::AtoB, 0)
            .unwrap();
