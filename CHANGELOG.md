...
- `swap3` does not support the deprecated `BaseFeeMode::RateLimiter`, therefore it does not take the instructions sysvar as a remaining account, unlike `swap` and `swap2`.
